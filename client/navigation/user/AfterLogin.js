...
class AfterLogin extends Component {
    ...
    fetchDetailUser = async (token) => {
        await this.props.dispatch(getCurrentProfileData(token));
    };
            ...
            <React.Fragment>
                        ...
                        {this.props.user.isLoading ? (
                            ...
                            <React.Fragment>
                                <Image
                                    ...
                                    source={{
                                        uri: this.props.user.data.image_profil,
                                    }}
                                />
                                <View
                                    style={{
                ...
                <View style={styles.body}>
                    <TouchableOpacity
                        style={styles.items}
                        onPress={() =>
                            this.props.navigation.navigate('PurchaseHistories')
                        }
                    >
                        <MaterialCommunityIcons
                            name="clipboard"
